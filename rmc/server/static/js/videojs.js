...
(function () {
    var videos = [
        ...
        'http://demo.dealerpro.net/Images/Sites/577/videos/HondaHands.mp4'
            ...
            , poster: ''
            , title: '<i class="fa fa-video-camera" aria-hidden="true"></i> Part1: Counting.'
    }
        , {
            src: [
        'http://1eb9cddbb30a65a675d4-91fe7d858d3e9c59dcdfd3e789416fbc.r56.cf1.rackcdn.com/Sites/577/commercial.mp4'
            ...
            , poster: ''
            , title: '<i class="fa fa-video-camera" aria-hidden="true"></i> Part2: Knowledge Title'
    }
        , {
            src: [
        'http://1eb9cddbb30a65a675d4-91fe7d858d3e9c59dcdfd3e789416fbc.r56.cf1.rackcdn.com/Sites/577/commercial.mp4'
            ...
            , poster: ''
            , title: '<i class="fa fa-video-camera" aria-hidden="true"></i> Part3: Knowledge Title'
    }
        , {
            src: [
        'http://1eb9cddbb30a65a675d4-91fe7d858d3e9c59dcdfd3e789416fbc.r56.cf1.rackcdn.com/Sites/577/commercial.mp4'
            ...
            , poster: ''
            , title: '<i class="fa fa-video-camera" aria-hidden="true"></i> Part4: Knowledge Title'
    }
        , {
            src: [
        'http://1eb9cddbb30a65a675d4-91fe7d858d3e9c59dcdfd3e789416fbc.r56.cf1.rackcdn.com/Sites/577/commercial.mp4'
            ...
            , poster: ''
            , title: '<i class="fa fa-video-camera" aria-hidden="true"></i> Part5: Knowledge Title'
    }
        , {
            src: [
        'http://1eb9cddbb30a65a675d4-91fe7d858d3e9c59dcdfd3e789416fbc.r56.cf1.rackcdn.com/Sites/577/commercial.mp4'
            ...
            , poster: ''
            , title: '<i class="fa fa-video-camera" aria-hidden="true"></i> Part6: Knowledge Title'
    }
        , {
            src: [
        'http://1eb9cddbb30a65a675d4-91fe7d858d3e9c59dcdfd3e789416fbc.r56.cf1.rackcdn.com/Sites/577/commercial.mp4'
            ...
            , poster: ''
            , title: '<i class="fa fa-video-camera" aria-hidden="true"></i> Part7: Knowledge Title'
    }
        , {
            src: [
        'http://1eb9cddbb30a65a675d4-91fe7d858d3e9c59dcdfd3e789416fbc.r56.cf1.rackcdn.com/Sites/577/commercial.mp4'
            ...
            , poster: ''
            , title: '<i class="fa fa-video-camera" aria-hidden="true"></i> Part8: Knowledge Title'
    }
    ...
    var demoModule = {
        ...
        , createListOfVideos: function () {
            ...
            for (var i = 0, len = this.player.pl.videos.length; i < len; i++) {
                html += '<li data-videoplaylist="' + i + '">' + '<span class="number">' + (i + 1) + '</span>' + '<span class="poster"><img src="' + videos[i].poster + '"></span>' + '<span class="title">' + videos[i].title + '</span>' + '</li>';
            }
