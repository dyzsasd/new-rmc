...
class SimpleReview(me.Document):

    # TODO test
    department = me.StringField(primary_key=True)
    course_id = me.StringField()
    hardness = me.FloatField()
    course_review = me.ListField(me.StringField())
